...
![Диаграмма коллинеарности признаков](https://github.com/denis-samatov/statistical_analysis_of_radiomics_data/blob/main/img_1.png)
...
![Нормализованные показатели важности](https://github.com/denis-samatov/statistical_analysis_of_radiomics_data/blob/main/img_2.png)
...
![Изменение кумулятивной важности признаков](https://github.com/denis-samatov/statistical_analysis_of_radiomics_data/blob/main/img_3.png)
...
![Количество уникальных значений для каждого признака](https://github.com/denis-samatov/statistical_analysis_of_radiomics_data/blob/main/img_4.png)
...
![ROC кривая и значения параметра ROC AUC](https://github.com/denis-samatov/statistical_analysis_of_radiomics_data/blob/main/img_5.png)
