...
![Диаграмма коллинеарности признаков](./images/example.jpg)
...
![Нормализованные показатели важности](./images/example.jpg)
...
![Изменение кумулятивной важности признаков](./images/example.jpg)
...
![Количество уникальных значений для каждого признака](./images/example.jpg)
...
![ROC кривая и значения параметра ROC AUC](./images/example.jpg)
